...
class kDataframe(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, kDataframe, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, kDataframe, name)
    ...
    if _newclass:
        ...
        load = _example.kDataframe_load
    __swig_destroy__ = _example.delete_kDataframe
    __del__ = lambda self: None
kDataframe_swigregister = _example.kDataframe_swigregister
kDataframe_swigregister(kDataframe)

def kDataframe_load():
    return _example.kDataframe_load()
kDataframe_load = _example.kDataframe_load

class kDataframeMQF(kDataframe):
    __swig_setmethods__ = {}
    for _s in [kDataframe]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, kDataframeMQF, name, value)
    __swig_getmethods__ = {}
    for _s in [kDataframe]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, kDataframeMQF, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        this = _example.new_kDataframeMQF()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
kDataframeMQF_swigregister = _example.kDataframeMQF_swigregister
kDataframeMQF_swigregister(kDataframeMQF)
